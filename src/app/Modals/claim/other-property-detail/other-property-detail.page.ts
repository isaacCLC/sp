...
@Component({
  selector: 'app-other-property-detail',
  templateUrl: 'other-property-detail.page.html',
  styleUrls: ['other-property-detail.page.scss'],
})
export class OtherPropertyDetailPage implements OnInit {
